...
export class TaskService {
  ...
  constructor() {
    let mockTasks: Task[] = [
      { name: 'Test 1', description: '', dateCreated: new Date(), priority: 4, status: 'Done' },
      ...
      { name: 'Test 3', description: 'description test', dateCreated: new Date(), priority: 4, status: 'Done' },
      { name: 'Test 4 ', description: 'description test', dateCreated: new Date(), priority: 4, status: 'Done' },
      { name: 'Test 5', description: 'description test', dateCreated: new Date(), priority: 4, status: 'Done' },
      ...
      { name: 'Test 8', description: 'description test', dateCreated: new Date(), priority: 4, status: 'Done' },
      { name: 'Test 9', description: 'description test', dateCreated: new Date(), priority: 4, status: 'Done' }
    ];
